...
<html lang="en">
    <head>
      ...
      <meta name="google-site-verification" content="fQwkiRRrRLPth5F2TQWkZWR-cq5RrldWdfHLDP6cLuA" />
    ...
    <body class="<?php echo strtolower(str_replace(' ', '-', $page_title)); ?>">
    <!-- Navbar -->
    <header>
        <nav id="nav-bg" class="navbar navbar-expand-md navbar-light fixed-top navbar-custom new-header">
            <div class="container">
        ...
        <span class="show-number">
            <a class="contact-number hide-on-large" href="tel:07467804534"><span class="material-symbols-outlined">Call</span>074 6780 4534</a>
            <button class="navbar-toggler" type="button" id="navbar-toggler-btn" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                <i class="material-icons" id="open-icon">menu</i>
                <i class="material-icons" id="close-icon" style="display:none;">close</i>
            </button>
        </span>
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                <li class="nav-item">
                    <a class="nav-link" href="index.php#services">Laser treatments</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.php#services">Semi-Perm Eyebrows</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.php#services">All Services</a>
                </li>
                <li class="nav-item">
            ...
            <div class="header-right-container">
                <a target="_blank" class="contact-number" href="tel:07467804534"><span class="material-symbols-outlined">Call</span>074 6780 4534</a>
                
                <a target="_blank" class="contact-number" href="mailto: lushlab.x@gmail.com"><span class="material-symbols-outlined">Mail</span></a>
                
                <a target="_blank" class="button-primary" href="https://www.fresha.com/book-now/lush-lab-beauty-clinic-pcvzsyjj/services?lid=1252661&eid=2910758&pId=1188943">Book today</a>
            </div>
    ...
    <section class="mega-nav nav-service-1">
        <div class="container">
            <div class="info-column-2">
                <h6>Laser services</h6>
                <ul>
                    <li><a href="https://www.lushlab.uk/laser-hair-removal.php">Laser hair removal</a></li>
                    <li><a href="https://www.lushlab.uk/skin-rejuvenation.php">Skin rejuvenation</a></li>
                    <li><a href="https://www.lushlab.uk/laser-tattoo-removal.php">Laser tattoo removal</a></li>
                </ul>
            </div>
            
            <div class="info-column">
                <h5>Contact us for a free consultation</h5>
                <p>Please contact us if you would like to have more information on any of our procedures.</p>
            </div>
            
            <div class="cta-column">
                <img src="./img/service/lash-brows/lash-and-eyebrow-treatments.png" alt="Laser hair removal services">
                <a target="_blank" class="button-primary" href="https://www.fresha.com/book-now/lush-lab-beauty-clinic-pcvzsyjj/services?lid=1252661&eid=2910758&pId=1188943">Book today</a>
            </div>
        </div>
    </section>